  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger
        ...
        className="grid size-10 place-items-center rounded-full text-fg-muted transition-colors hover:bg-hover hover:text-fg lg:hidden"
      >
      ...
      <Dialog.Portal>
        ...
        >
          <div className="flex items-center justify-between px-2">
            <Logo />
            <Dialog.Close aria-label="Close menu" className="grid size-9 place-items-center rounded-lg text-fg-subtle hover:bg-hover hover:text-fg">
              <X className="size-4" />
            </Dialog.Close>
          </div>
              ...
              if (!enabled) {
                return (
                  <span key={href} className="flex items-center justify-between rounded-[12px] px-3 py-2.5 text-sm text-fg-subtle/60">
                    ...
                    <span className="rounded-full bg-hover px-1.5 py-0.5 text-[10px]">soon</span>
                  </span>
                );
              }
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active ? "bg-brand/12 text-brand ring-1 ring-brand/20" : "text-fg-muted hover:bg-hover hover:text-fg",
                  )}
                >
