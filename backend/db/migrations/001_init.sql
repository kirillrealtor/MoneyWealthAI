-- =====================================================================
-- 001_init — Core schema (canonical, executable source of truth).
-- See db/schema.sql for the annotated full-design reference.
-- =====================================================================
...
CREATE TABLE tenants (
  ...
  plan           VARCHAR(50) NOT NULL DEFAULT 'retail',
...
CREATE TABLE users (
  ...
  phone            VARCHAR(20),
  advisor_persona  VARCHAR(50) NOT NULL DEFAULT 'balanced',
...
CREATE TABLE plaid_items (
  ...
  item_status      VARCHAR(50) NOT NULL DEFAULT 'good',
