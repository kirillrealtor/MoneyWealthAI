      ...
      <header className="sticky top-0 z-30 border-b border-line bg-ink-2/90 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-4 px-5">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active ? "bg-iris/15 text-iris ring-1 ring-iris/25" : "text-fg-muted hover:bg-hover hover:text-fg",
                  )}
                >
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={logout} aria-label="Sign out" className="grid size-8 place-items-center rounded-lg text-fg-subtle hover:bg-hover hover:text-fg">
